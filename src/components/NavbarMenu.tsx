            ...
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
              <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="size-6 mr-3 text-slate-400"
                >
                  <path
                    strokeLinecap="round"
              ...
              <ChevronDownIcon
                aria-hidden="true"
                className="h-5 w-5 flex-none text-sky-300"
              />
            </PopoverButton>
            <PopoverPanel
              transition
                ...
                <div className="p-4">
                  <Link to={"/profile"} className="svg">
                    <div className="flex items-center">
                      ...
                      <p className="block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-500">
                        Perfil
                      </p>
                    </div>
                  </Link>
